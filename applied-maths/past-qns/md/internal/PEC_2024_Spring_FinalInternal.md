...
**Level:** Bachelor | **Semester:** 2024 Spring  
**Programme:** B.E. Computer  
**Course:** Applied Mathematics  
**Full Mark:** 100 | **Pass Mark:** 40 | **Time:** 3 hrs.
...
Find the solution of the one-dimensional heat equation $\frac{\partial u}{\partial t} = c^2 \frac{\partial^2 u}{\partial x^2}$ with initial temperature $f(x)$ and boundary conditions $u(0, t) = 0$ and $u(L, t) = 0$. **[7]**
...
#### 6. Attempt any two: **[2 x 5 = 10]**
a) Show that $z \bar{z}$ is not an analytic function.
b) Find the location and order of zeros of $(z^2 + 1)(e^z - 1)$.
